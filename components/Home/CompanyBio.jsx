...
function CompanyBio() {
  return (
    <div className="w-full min-h-screen bg-green-main flex justify-center items-center">
      <div className="w-full h-full max-w-[1290px] m-auto flex flex-col gap-10 justify-center items-center">
        <h1 className="text-[60px] text-blue-main font-semibold font-anton">
          Company Bio
        </h1>
        <p className="w-[80%] text-[20px] text-blue-main font-normal font-sans ">
